...
\end{enumerate}
\end{definition}
\TODO[inline]{This definition is for the steiner tree not a smt, thus this
  should be moved. smith agrees on the definition of a smt as the first definition.}
%
\begin{proof}
...
\TODO[inline]{Describe geosteiner/refer that the algorithm is very involved =
  gloss over it, then describe why this does not generalize to
d-space.}
