...
\end{itemize}
%
The chapter will also present known methods for finding Steiner trees in 2D, why
they are effective and why they do not generalize to higher dimensions. Known
related owrk into the field of finding \aclp{smt} in $d$-space is then presented.

Finally chapter also introduces versions of the Steiner tree
problem not used directly in the thesis, but which help to give an
understanding of the problem area of the thesis, and the possible applications
for the Steiner tree in $d$-space.
