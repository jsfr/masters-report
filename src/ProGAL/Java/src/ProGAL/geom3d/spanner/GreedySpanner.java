...
import ProGAL.dataStructures.DijkstraShortestPath;
...
public class GreedySpanner extends WeightedGraph{
	...
	private void constructFromEdges(List<Pair<Integer,Integer>> allEdges, double t){
		...
		for(Pair<Integer,Integer> pair: allEdges){
			DijkstraShortestPath sp = new DijkstraShortestPath(this,pair.fst); //TODO: Optimize with dynamic all-pairs shortest path
